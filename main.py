...
def hesapla_ve_kaydet():
    try:
        ...
        global grup_net_agirlik  # global anahtar kelimesini ekledik
        ...
        global toplam_net_agirlik  # global anahtar kelimesini ekledik
...
def kaydet():
    try:
        ...
        if dosya_yolu:
            ...
            writer.save()  # save() işlevselliğini kullanın
...
Button(app, text="Hesapla ve Kaydet", command=hesapla_ve_kaydet).pack(pady=20)
